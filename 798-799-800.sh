...
${java} -Xmx45g -jar ${gatk} -T UnifiedGenotyper -R ${ref}.fa -glm BOTH -I WGC034798U_dedup_realign_recal.bam -I WGC034799U_dedup_realign_recal.bam -I WGC034800U_dedup_realign_recal.bam --dbsnp: ./hg19/dbsnp_138.hg19.vcf -stand_call_conf 30 -stand_emit_conf 10 -o 798-799-800Fam_dedup_realign_recal_rawU_allvar.vcf -minIndelCnt 4 -minIndelFrac 0.05 -dcov 1000 2>>callvar_err

${java} -Xmx45g -jar ${gatk} -T VariantRecalibrator -R ${ref}.fa -input 798-799-800Fam_dedup_realign_recal_rawU_allvar.vcf -mode SNP -resource:hapmap,known=false,training=true,truth=true,prior=15.0 ./hg19/hapmap_3.3.hg19.vcf -resource:omni,known=false,training=true,truth=false,prior=12.0 ./hg19/1000G_omni2.5.hg19.vcf -resource:1000G,known=false,training=true,truth=false,prior=10.0 ./hg19/1000G_phase1.indels.hg19.vcf -resource:dbsnp,known=true,training=false,truth=false,prior=2.0 ./hg19/dbsnp_138.hg19.vcf -an DP -an FS -an MQRankSum -an ReadPosRankSum -tranche 100.0 -tranche 99.9 -tranche 99.0 -tranche 90.0 --maxGaussians 4 -recalFile 798-799-800Fam_dedup_realign_recal_rawU_snp.recal -tranchesFile 798-799-800Fam_dedup_realign_recal_rawU_snp.tranches -rscriptFile 798-799-800Fam_dedup_realign_recal_rawU_snp_plots.R 2>>callvar_err

${java} -Xmx45g -jar ${gatk} -T VariantRecalibrator -R ${ref}.fa -input 798-799-800Fam_dedup_realign_recal_rawU_allvar.vcf -mode INDEL -resource:mills,known=true,training=true,truth=true,prior=12.0 ./hg19/Mills_and_1000G_gold_standard.indels.hg19.vcf -an DP -an FS -an MQRankSum -an ReadPosRankSum -tranche 100.0 -tranche 99.9 -tranche 99.0 -tranche 90.0 --maxGaussians 4 -recalFile 798-799-800Fam_dedup_realign_recal_rawU_indel.recal -tranchesFile 798-799-800Fam_dedup_realign_recal_rawU_indel.tranches -rscriptFile 798-799-800Fam_dedup_realign_recal_rawU_indel_plots.R 2>>callvar_err

${java} -Xmx45g -jar ${gatk} -T ApplyRecalibration -R ${ref}.fa -input 798-799-800Fam_dedup_realign_recal_rawU_allvar.vcf -mode SNP --ts_filter_level 99.0 -recalFile 798-799-800Fam_dedup_realign_recal_rawU_snp.recal -tranchesFile 798-799-800Fam_dedup_realign_recal_rawU_snp.tranches -o 798-799-800Fam_dedup_realign_recal_rawU_snpF.vcf 2>>callvar_err

${java} -Xmx45g -jar ${gatk} -T ApplyRecalibration -R ${ref}.fa -input 798-799-800Fam_dedup_realign_recal_rawU_snpF.vcf -mode INDEL --ts_filter_level 99.0 -recalFile 798-799-800Fam_dedup_realign_recal_rawU_indel.recal -tranchesFile 798-799-800Fam_dedup_realign_recal_rawU_indel.tranches -o 798-799-800Fam_dedup_realign_recal_rawU_snpF_indelF.vcf 2>>callvar_err

#/software/biosoft/software/java1.7/jdk1.7.0_45/bin/java -jar /software/biosoft/software/gatk/GenomeAnalysisTK.jar -T SelectVariants -R hg19_gatkorder.fa --variant zhwwFam_dedup_realign_recal_rawU_snpF_indelF.vcf -o zhwwFam_dedup_realign_recal_rawU_snp_indel_snpF_indelF_INDEL_filter.vcf -selectType INDEL 2>>callvar_err

...
#PBS -N WGC034809U
#PBS -q middleq
#PBS -e WGC034809U_script_err
#PBS -o WGC034809U_script_log
...
/software/biosoft/software/bwa-0.7.10/bwa sampe -r "@RG\tID:WGC809\tLB:WGC809\tPL:illumina\tSM:WGC809" ${ref}.fa ../${name}_R1.sai ../${name}_R2.sai ${R1}.fastq ${R2}.fastq > ${name}.sam 2>>${name}_err

...
#PBS -N WGC034805U
#PBS -q largeq
#PBS -e WG034805U_script_err
#PBS -o WG034805U_script_log
#PBS -l mem=100gb,walltime=24:00:00,nodes=1:ppn=8
#HSCHED -s hschedd
...
#/software/biosoft/software/java1.7/jdk1.7.0_45/bin/java -Xmx45g -jar /software/biosoft/software/gatk/GenomeAnalysisTK.jar -T UnifiedGenotyper -R ${ref}.fa -glm BOTH -I ${name}_dedup_realign_recal.bam --dbsnp: ./hg19/dbsnp_138.hg19.vcf -stand_call_conf 30 -stand_emit_conf 10 -o ${name}_dedup_realign_recal_rawU_snp_indel.vcf -minIndelCnt 4 -minIndelFrac 0.05 -dcov 1000 2>>${name}_err
